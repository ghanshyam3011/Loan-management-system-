import sqlite3  # To Integrate SQLite with Python
from tkinter import * # To add Graphical Users Interfaces (GUIs)
from tkinter import ttk, messagebox # To pop up msg box
 
 
class LoanManager:
    def __init__(self, root):
        
        # To declare the class with window format
        self.root = root
        
        # Set the title and size of the root window
        self.root.title(" AU Loan Management System")
        self.root.geometry("1350x230+0+0")
        
        # To create Label and give the style to it 
        title = Label(self.root, text="AU Loan Management System", font=(
            "bariol", 40,), bd=8,  bg='grey', fg='black')
        ...
        txt_mob = Entry(Detail_F, font=("dibot", 10, ),
        ...
        txt_amount = Entry(Detail_F, font=(
            "dibot", 10, ), bd=3,  textvariable=self.amount)
        ...
        txt_time = Entry(Detail_F, font=("dibot", 10,
        ...
        txt_rate = Entry(Detail_F, font=("dibot", 10,
    ...
    def delete(self):
        if self.LoanId.get() == '':
            messagebox.showerror(
                'Oops !! Error', 'Enter customer ID to delete the records')
        else:
            con = sqlite3.connect('loanDetails.db')
            cur = con.cursor()
...
class Login():
    def __init__(self, root):
        ...
        # Start the root window with passed argument
        self.root = root
    ...
    def login(self):
        ...
        if self.username.get() == "hari" and self.password.get() == "11":
